...
class DistrictForm(forms.ModelForm):
    """Form for creating and editing District objects"""
...
class DistrictFilterForm(forms.Form):
    """Form for filtering District objects"""
...
class CouncilForm(forms.ModelForm):
    ...
    class Meta:
        model = Council
        fields = ['name', 'district', 'calendar_badge_name']
        widgets = {
...
class PartyForm(forms.ModelForm):
    ...
    class Meta:
        model = Party
        fields = ['name', 'short_name', 'district', 'description', 'color', 'logo']
        widgets = {
            'name': forms.TextInput(attrs={'class': 'form-control'}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        if district_id:
            try:
                ...
                self.fields['district'].initial = district_obj.pk
    ...
    def __init__(self, *args, **kwargs):
        ...
        if committee_id:
            try:
                ...
                district_obj = committee.council.district
                # Get all groups for parties in this local
                groups = Group.objects.filter(party__district=district_obj, is_active=True)
