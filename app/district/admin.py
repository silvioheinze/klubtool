...
class CouncilAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Basic Information', {
            'fields': ('name', 'district', 'is_active')
        }),
        ('Timestamps', {
            'fields': ('created_at', 'updated_at'),
            'classes': ('collapse',)
...
@admin.register(DistrictEventParticipation)
class DistrictEventParticipationAdmin(admin.ModelAdmin):
    list_display = ['event', 'user', 'will_attend', 'updated_at']
    list_filter = ['will_attend', 'event__district']
