    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('committee', models.ForeignKey(help_text='Committee holding the meeting', on_delete=django.db.models.deletion.CASCADE, related_name='meetings', to='district.committee')),
            ],
            options={
